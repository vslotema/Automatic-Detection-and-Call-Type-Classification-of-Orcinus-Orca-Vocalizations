...
ap.add_argument("--data-dir", type=str, default="C:\\myProjects\\THESIS\\Data\\deep+aud\\",
...
ap.add_argument("--res-dir", type=str, default="discard\\", help="path to model results plot,weights,checkpoints etc.")
...
if __name__ == '__main__':
    ...
    tensorboard = tf.keras.callbacks.TensorBoard(log_dir=LOG, histogram_freq=1)
    ...
    logger = tf.keras.callbacks.CSVLogger(HISTORY_CSV,separator=",",append=True)
    ...
    H = model.fit_generator(generator=training_generator, epochs=ARGS.n_epochs, initial_epoch=ARGS.initial_epoch,
                            ...
                            callbacks=[mcheckpoint, reduce_lr, earlystop,logger,tensorboard])
